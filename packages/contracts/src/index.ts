export type BuoyPlatform = 'desktop' | 'mobile';
...
export interface SessionMeta {
  ...
  /** Explicitly closed by the user after tmux was snapshotted and ended. */
  archived?: boolean;
  /** Epoch milliseconds used to order the History list, when known. */
  archivedAt?: number | null;
  /** Explicit client detach; unlike archived/closed, the tmux server is still alive. */
  detached?: boolean;
